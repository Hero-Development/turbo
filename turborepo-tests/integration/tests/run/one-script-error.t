...
Note that npm reports any failed script as exit code 1, even though we "exit 2"
  ...
  my-app:okay: cache miss, executing 2217e04955a95b30
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo 'working'
  my-app:okay: 
  my-app:okay: working
  my-app:error: cache miss, executing 5e792551b2ce002d
  my-app:error: 
  my-app:error: > error
  my-app:error: > exit 2
  my-app:error: 
...
Make sure error isn't cached
  ...
  \xe2\x80\xa2 Running error in 1 packages (esc)
  \xe2\x80\xa2 Remote caching disabled (esc)
  my-app:okay: cache hit, replaying logs 2217e04955a95b30
  my-app:okay: 
  my-app:okay: > okay
  my-app:okay: > echo 'working'
  my-app:okay: 
...
Make sure error code isn't swallowed with continue
  ...
  my-app:okay2: cache miss, executing 3b8de377da7c1afd
  my-app:okay2: 
  my-app:okay2: > okay2
